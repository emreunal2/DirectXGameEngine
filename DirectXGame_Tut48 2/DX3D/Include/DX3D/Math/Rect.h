...
public:
	...
	Rect(i32 n_width, i32 n_height) : width(n_width), height(n_height), left(0), top(0) {}
	Rect(i32 n_left, i32 n_top, i32 n_width, i32 n_height)
		: width(n_width), height(n_height), left(n_left), top(n_top) {
	}
